...
<head>
    ...
    <link href="../site/assets/css/material-kit.css?v=1.2.1" rel="stylesheet"/>

    <!-- CSS Just for demo purpose, don't include it in your project -->
    <link href="../site/assets/css/vertical-nav.css" rel="stylesheet" />
...
<div class="cd-section" id="teams">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card card-profile card-plain">
                        <div class="card-image">
                            <a href="#pablo">
                                <img class="img" src="assets/img/examples/card-profile2.jpg" />
                            </a>
                        </div>
    ...
    <div class="team-4 section-image" style="background-image: url('assets/img/bg7.jpg')">
    ...
    <div class="team-5 section-image" style="background-image: url('assets/img/examples/city.jpg')">
    ...
    <div class="projects-1" id="projects-1">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="card card-raised card-background"  style="background-image: url('assets/img/examples/card-blog3.jpg')">
                        <div class="card-content">
            ...
            <div class="row">
                ...
                <div class="col-md-5 col-md-offset-1">
                    <div class="card card-plain">
                        <a href="#pablo">
                            <div class="card-image">
                                <img src="assets/img/examples/card-project1.jpg" />
                            </div>
                        </a>
                        <div class="card-content">
                ...
                <div class="col-md-5">
                    <div class="card card-plain">
                        <a href="#pablo">
                            <div class="card-image">
                                <img src="assets/img/examples/card-project2.jpg" />
                            </div>
                        </a>
                        <div class="card-content">
                ...
                <div class="col-md-5 col-md-offset-1">
                    <div class="card card-plain">
                        <a href="#pablo">
                            <div class="card-image">
                                <img src="assets/img/examples/card-project3.jpg" />
                            </div>
                        </a>
                        <div class="card-content">
                ...
                <div class="col-md-5">
                    <div class="card card-plain">
                        <a href="#pablo">
                            <div class="card-image">
                                <img src="assets/img/examples/card-project4.jpg" />
                            </div>
                        </a>
                        <div class="card-content">
    ...
    <div class="projects-4" id="projects-4">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-5 col-md-offset-1">
                    <div class="card card-background" style="background-image: url('assets/img/examples/card-project2.jpg')">
                        <a href="#pablo">
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    <div class="card card-background" style="background-image: url('assets/img/examples/card-project5.jpg')">
                        <a href="#pablo">
                        </a>
                        <div class="card-content">
...
<div class="cd-section" id="pricing">
    ...
    <div class="pricing-1 section-image" style="background-image: url('assets/img/bg11.jpg')" id="pricing-1">
    ...
    <div class="pricing-3 section-image" style="background-image: url('assets/img/examples/city.jpg')" id="pricing-3">
                    ...
                    <div class="card card-pricing card-plain">
                        <div class="card-content">
                            ...
                            <ul>
                                <li><i class="material-icons text-success">check</i> Sharing Tools</li>
                                <li><i class="material-icons text-success">check</i> Design Tools</li>
                                <li><i class="material-icons text-success">check</i> Private Messages</li>
                                <li><i class="material-icons text-danger">close</i> Personal Brand</li>
                            </ul>
                    ...
                    <div class="card card-pricing card-plain">
                        <div class="card-content">
                            ...
                            <ul>
                                ...
                                <li><i class="material-icons text-success">check</i> Design Tools</li>
                                <li><i class="material-icons text-success">check</i> Private Messages</li>
                                <li><i class="material-icons text-success">check</i> Personal Brand</li>
                            </ul>
                            <a href="#pablo" class="btn btn-success btn-round">
                                Upgrade Plan
                            </a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <p class="text-gray">You have Free Unlimited Updates and Premium Support on each package. You also have 20 days to request a refund if you're not happy with your purchase.</p>
                </div>
...
<script src="../site/assets/js/material.min.js"></script>

<!--    Plugin for Date Time Picker and Full Calendar Plugin   -->
<script src="../site/assets/js/moment.min.js"></script>

<!--	Plugin for the Sliders, full documentation here: http://refreshless.com/nouislider/   -->
<script src="../site/assets/js/nouislider.min.js" type="text/javascript"></script>

<!--	Plugin for the Datepicker, full documentation here: https://github.com/Eonasdan/bootstrap-datetimepicker   -->
<script src="../site/assets/js/bootstrap-datetimepicker.js" type="text/javascript"></script>

<!--	Plugin for Select, full documentation here: http://silviomoreto.github.io/bootstrap-select   -->
<script src="../site/assets/js/bootstrap-selectpicker.js" type="text/javascript"></script>

<!--	Plugin for Tags, full documentation here: http://xoxco.com/projects/code/tagsinput/   -->
<script src="../site/assets/js/bootstrap-tagsinput.js"></script>

<!--	Plugin for Fileupload, full documentation here: http://www.jasny.net/bootstrap/javascript/#fileinput   -->
<script src="../site/assets/js/jasny-bootstrap.min.js"></script>
...
<script src="../site/assets/js/material-kit.js" type="text/javascript"></script>
