                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-5 col-md-6">
                                <div class="dropup">
                                    <button href="#pablo" class="dropdown-toggle btn btn-primary btn-round btn-block" data-toggle="dropdown">Dropup <b class="caret"></b></button>
            ...
            <div id="images">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-2 col-sm-offset-1">
                        ...
                        <img src="assets/img/faces/avatar.jpg" alt="Raised Image" class="img-rounded img-responsive img-raised">
                    </div>

                    <div class="col-sm-2 col-sm-offset-1">
                        <h4>Circle Raised</h4>
                        <img src="assets/img/faces/avatar.jpg" alt="Thumbnail Image" class="img-circle img-raised img-responsive">
                    </div>
                </div>
                <div class="row">
    ...
    <div id="cards" class="cd-section">
        <div class="section-gray">
            ...
            <div class="cards" id="morphing">
                ...
                <div class="container">
                    <div class="title">
                        <h2 id="morphingCards">Morphing Cards</h2>
                                    ...
                                    <div class="back content-rose">
                                        <div class="card-content">
                                            ...
                                            <div class="footer">
                                                ...
                                                <button type="button" name="button" class="btn btn-white btn-simple">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-4">
                            ...
                            <div class="rotating-card-container manual-flip">
                                <div class="card card-rotate">
                                    <div class="front front-background" style="background-image: url('assets/img/examples/card-blog6.jpg');">
                                        <div class="card-content">
                                            <h6 class="category text-info">Full Background Card</h6>
                                            <a href="#pablo">
                                    ...
                                    <div class="back back-background" style="background-image: url('assets/img/examples/card-blog6.jpg');">
                                        <div class="card-content">
                                            <h5 class="card-title">
                                                Manage Post
                                            </h5>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card card-blog">
                            ...
                            <div class="card-content">
                                <h6 class="category text-warning">Dynamic Shadows</h6>
                                <h4 class="card-title">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card card-blog">
                            ...
                            <div class="card-content">
                                <h6 class="category text-rose">Dynamic Shadows</h6>
                                <h4 class="card-title">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card card-blog">
                            ...
                            <div class="card-content">
                                <h6 class="category text-info">Dynamic Shadows</h6>
                                <h4 class="card-title">
        ...
        <div class="container">
            ...
            <div class="row" id="modals">
                <div class="col-md-6">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <button class="btn btn-raised btn-round btn-default btn-block" data-toggle="modal" data-target="#smallAlertModal">
            ...
            <div class="modal-body">
                <div class="instruction">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="picture">
                                <img src="assets/img/dg1.jpg" alt="Thumbnail Image"  class="img-rounded img-responsive">
                            </div>
                        </div>
                    </div>
                </div>
