<nav class="light-red">
    <div class="container">
        <div class="nav-wrapper">
            <a href="index.php?page=home" class="brand-logo">Gomab | Admin</a>
                ...
                <?php
                    if($page != 'login' && $page != 'new'){
                        ...
                        <ul class="right hide-on-med-and-down">
                            <li class="<?php echo ($page=="dashboard")?"active" : ""; ?>"><a href="index.php?page=dashboard">
                            ...
                            <li><a href="../site/index.php?page=home">Quitter</a></li>
                ...
                <?php
                    if($page != 'login' && $page != 'new'){
                        ...
                        <ul class="side-nav" id="mobile-menu">
                            ...
                            <li class="<?php echo ($page=="settings")?"active" : ""; ?>"><a href="index.php?page=settings">Parametres</a></li>
