...
<div class="row">
    ...
    <?php
    //Afficher automatiquement le nom de la tble et le nombre d'entrée
        $tables = [
                'Publications'    => 'posts',
        ...
        //Tableau qui attribue des couleurs
        $colors =[
                'posts'    => 'green',
                'comments' => 'red',
                'admins'   => 'blue'
                        ...
                        <div class="modal" id="comment_<?= $comment->id ?>">
                            <div class="modal-content">
                                ...
                                <p>Commentaire posté par
                                    <strong><?= $comment->name . " (" . $comment->email . ")</strong><br/>Le " . date("d/m/Y à H:i:s", strtotime($comment->date)) ?>
                                </p>
                                <hr/>
