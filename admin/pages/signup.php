...
<head>
    ...
    <link href="../assets/assets2/css/material-kit.css" rel="stylesheet"/>
...
<body class="signup-page">
	...
	<!--   Core JS Files   -->
	<script src="../assets/assets2/js/jquery.min.js" type="text/javascript"></script>
	<script src="../assets/assets2/js/bootstrap.min.js" type="text/javascript"></script>
	<script src="../assets/assets2/js/material.min.js"></script>

	<!--  Plugin for the Sliders, full documentation here: http://refreshless.com/nouislider/ -->
	<script src="../assets/assets2/js/nouislider.min.js" type="text/javascript"></script>

	<!--  Plugin for the Datepicker, full documentation here: http://www.eyecon.ro/bootstrap-datepicker/ -->
	<script src="../assets/assets2/js/bootstrap-datepicker.js" type="text/javascript"></script>

	<!-- Control Center for Material Kit: activating the ripples, parallax effects, scripts from the example pages etc -->
	<script src="../assets/assets2/js/material-kit.js" type="text/javascript"></script>
